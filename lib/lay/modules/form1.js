							...
							if(!r) {
								var b = function() {
									...
									downkey = function() {
										var selectIndex = 0 ;
										var nextIndex = 0;
										var options = t.find("dl dd");
										var len = options.length;
										options.each(function(index,obj){
											if(i(obj).attr("class") == "layui-this"){
												selectIndex = index;
											}
										});
										if(selectIndex == len -1){
											...
											nextIndex = Number(selectIndex) + 1;
										}
										options.eq(selectIndex).attr("class","");
										options.eq(nextIndex).attr("class","layui-this");
										t.addClass(a + "ed");
									};
